...
Public Class Win_SélecteurDOuvrage
...
#Region "Déclaration et registration de CritèreMotsClésProperty"
    ...
    Public Shared CritèreMotsClésProperty As DependencyProperty = DependencyProperty.Register("CritèreMotsClés", GetType(String), GetType(Win_SélecteurDOuvrage), MDCritèreMotsClés)
...
#Region "Evènnement CritèreMotsClésChangedEvent et son Wrapper CLR (Non testé !!!)"
    ...
    Public Shared ReadOnly CritèreMotsClésChangedEvent As RoutedEvent =
                  EventManager.RegisterRoutedEvent("CritèreMotsClésChangedEvent", RoutingStrategy.Bubble,
                                                                                      GetType(RoutedPropertyChangedEventHandler(Of String)), GetType(Win_SélecteurDOuvrage))
...
#End Region
    ...
    Private Shared Sub OnCritèreMotsClésInvalidated(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)
        ...
        Dim Sender As Win_SélecteurDOuvrage = d
    ...
    Private Sub OnCritèreMotsClésChanged(ByVal OldValue As String, ByVal NewValue As String)
        ...
        args.RoutedEvent = Win_SélecteurDOuvrage.CritèreMotsClésChangedEvent
...
#Region "CritèreMotsClésProduits (String)"
    ...
    Public Shared ReadOnly CritèreMotsClésProduitsProperty As DependencyProperty =
            DependencyProperty.Register("CritèreMotsClésProduits", GetType(String), GetType(Win_SélecteurDOuvrage), New UIPropertyMetadata(Nothing, New PropertyChangedCallback(Sub(Sender As Win_SélecteurDOuvrage, e As DependencyPropertyChangedEventArgs)
...
#Region "Déclaration et registration de CritèreCodeLydicProperty"
    ...
    Public Shared CritèreCodeLydicProperty As DependencyProperty = DependencyProperty.Register("CritèreCodeLydic", GetType(String), GetType(Win_SélecteurDOuvrage), MDCritèreCodeLydic)
...
#End Region
    ...
    Private Sub OnCritèreCodeLydicChanged(ByVal OldValue As String, ByVal NewValue As String)
        ...
        Dim args As New RoutedPropertyChangedEventArgs(Of String)(OldValue, NewValue)
        args.RoutedEvent = Win_SélecteurDOuvrage.CritèreCodeLydicChangedEvent
...
#Region "Déclaration et registration de CritèreRefFournisseurProperty"
    ...
    Public Shared CritèreRefFournisseurProperty As DependencyProperty = DependencyProperty.Register("CritèreRefFournisseur", GetType(String), GetType(Win_SélecteurDOuvrage), MDCritèreRefFournisseur)
...
#Region "RechercheSurDemande (Boolean)"
    ...
    Public Shared ReadOnly RechercheSurDemandeProperty As DependencyProperty =
            DependencyProperty.Register("RechercheSurDemande", GetType(Boolean), GetType(Win_SélecteurDOuvrage), New UIPropertyMetadata(False))
...
#Region "LaSourceEstLeRéférentiel (Boolean)"
    ...
    Public Shared ReadOnly LaSourceEstLeRéférentielProperty As DependencyProperty =
            DependencyProperty.Register("LaSourceEstLeRéférentiel", GetType(Boolean), GetType(Win_SélecteurDOuvrage),
                                        New UIPropertyMetadata(True,
                                                               New PropertyChangedCallback(
                        Sub(Sender As Win_SélecteurDOuvrage, e As DependencyPropertyChangedEventArgs)
                            ...
                            If Sender.LaSourceEstLeRéférentiel Then
                                Sender.Title = BaseTitre & "de patron d'ouvrage"
                            Else
                                Sender.Title = BaseTitre & "d'ouvrage"
                            End If
                            Ouvrage_Base.SetMotsPourTousLesOuvrages(Sender.LaSourceEstLeRéférentiel, Not Sender.LaSourceEstLeRéférentiel)
...
#Region "DistanceTolérée (short)"
    ...
    Public Shared ReadOnly DistanceToléréeProperty As DependencyProperty =
            DependencyProperty.Register("DistanceTolérée", GetType(Short), GetType(Win_SélecteurDOuvrage),
                                        New UIPropertyMetadata(CShort(0), New PropertyChangedCallback(
                                                               Sub(Sender As Win_SélecteurDOuvrage,
...
#Region "Déclaration et registration de OuvrageSélectionnéProperty"
    ...
    Public Shared OuvrageSélectionnéProperty As DependencyProperty = DependencyProperty.Register("OuvrageSélectionné", GetType(Ouvrage_Base), GetType(Win_SélecteurDOuvrage), MDOuvrageSélectionné)
...
#Region "Evènnement OuvrageSélectionnéChangedEvent et son Wrapper CLR (Non testé !!!)"
    ...
    Public Shared ReadOnly OuvrageSélectionnéChangedEvent As RoutedEvent =
                  EventManager.RegisterRoutedEvent("OuvrageSélectionnéChangedEvent", RoutingStrategy.Bubble,
                                                                                      GetType(RoutedPropertyChangedEventHandler(Of Ouvrage)), GetType(Win_SélecteurDOuvrage))
...
#Region "Déclaration et registration de InfosResultatProperty"
    ...
    Public Shared InfosResultatPropertyKey As DependencyPropertyKey = DependencyProperty.RegisterReadOnly("InfosResultat", GetType(String), GetType(Win_SélecteurDOuvrage), MDInfosResultat)
...
#Region "MatcheCritères"
    ...
    Private Function MatcheCritèresProduits(o As Ouvrage_Base, CritèreMotsClés As String, critèreCodeLydic As String, critèreRefFournisseur As String) As Boolean
        ...
        If AucunCritère Then
            r = True
        Else
            r = (From up In o.UsagesDeProduit Where Win_SélecteurDeProduit.MatcheCritères(up.Produit, CritèreMotsClés, critèreCodeLydic, critèreRefFournisseur)).Any()
        End If
        Return r
    End Function
